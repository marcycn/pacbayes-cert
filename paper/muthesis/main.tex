...
benchmarks were used throughout.
...
\begin{uomappendix}
    ...
    The artefact accompanying this dissertation is deposited at [artefact locator];
    ...
    \texttt{<dataset>\_<objective>\_<prior>\_<model>.yaml},
